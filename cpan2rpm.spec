#
#   - cpan2rpm -
#   This spec file was automatically generated by cpan2rpm [ver: 2.025]
...
buildarch: noarch
prefix:    %(echo %{_prefix})
requires:  %([ -e /etc/SuSE-release -o -e /etc/UnitedLinux-release ] && SuSE=1;ver=`rpm -q rpm --qf %%{version}|awk -F . '{print $1}'`;[ $ver -le 3 -o -s $SuSE ] && echo rpm || echo rpm-build)
source:    cpan2rpm-2.025.tar.gz
