#
# This spec file was automatically generated by cpan2rpm v2.010
...
%{__perl} Makefile.PL `%{__perl} -MExtUtils::MakeMaker -e '
...
%{makeinstall} `%{__perl} -MExtUtils::MakeMaker -e '
